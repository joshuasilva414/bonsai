/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 36ce49ed92c3b242c4446e57cdb45fc2)
// Runtime types generated with workerd@1.20260801.1 2026-08-07 nodejs_compat_v2
interface __BaseEnv_Env {
	...
	TextbookAgent: DurableObjectNamespace<import("./src/server").TextbookAgent>;
	CREATE_COURSE_WORKFLOW: Workflow<Parameters<import("./src/server").CreateCourseWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "TextbookAgent";
	}
